/**
 * Rectangle annotation tool (outline and solid share this handler).
 * The store's currentTool distinguishes "rectangleOutline" vs "rectangleSolid".
 */
...
export const rectTool: ToolHandler = {
  onMouseDown(pos) {
    ...
    const type = state.currentTool === "rectangleSolid" ? "rectangleSolid" : "rectangleOutline";
    start = pos;
